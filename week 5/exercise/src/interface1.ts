...
Et ? efter parameter gør det optional

e) Change the interface to make author readonly - Verify the new behaviour.

readonly foran parameter. Man kan IKKE ændre en readonly attribute efter den er oprettet. Meget i stil med final i java
